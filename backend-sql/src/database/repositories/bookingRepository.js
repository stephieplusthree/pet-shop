...
class BookingRepository extends AbstractRepository {
  ...
  async create(data, options) {
    const record = await models.booking.create(
      {
  ...
  async update(id, data, options) {
    let record = await models.booking.findByPk(id, {
      transaction: AbstractRepository.getTransaction(
        options,
      ),
    });
  ...
  async findById(id, options) {
    const record = await models.booking.findByPk(
      id,
      {
  ...
  async findAndCountAll(
    ...
    let { rows, count } = await models.booking.findAndCountAll({
